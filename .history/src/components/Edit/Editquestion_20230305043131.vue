...
<script>
import { deletequestion, getquestion, putquestion } from "@/services/question";
...
export default {
  ...
  methods: {
    delete: function (e) {
      e.preventDefault();
      deletequestion(this.$route.params.id, token).then((response) => {
        if (response.error) {
          this.$toasted.error(response.error);
        } else if (response.message) {
          this.$route.replace("/edit");
    ...
    finish: function (e) {
      ...
      putquestion(data, token, this.$route.params.id)
        .then((response) => {
          if (response.error) {
            this.$toasted.error(response.error);
          } else if (response.message) {
