<template>
  <div class="p-10">
    ...
    <div class="flex flex-col items-center justify-center ">
      <div
        class="w-full sm:w-1/2 lg:w-1/2 drop-shadow-xl mb-4 hover:drop-shadow-2xl border border-gray-400 lg:border-l lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b lg:rounded-t p-4 flex flex-col justify-between leading-normal"
      ...
      >
        <div class="mb-8">
          ...
          >
            ...
            <div v-show="!edit" class="text-gray-600">
