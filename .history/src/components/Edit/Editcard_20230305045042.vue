<template>
  <div class="p-10">
    ...
    <div class="flex-1 flex-col items-center justify-center lg:flex">
      <div
        class="w-full sm:w-1/2 lg:w-/3 drop-shadow-xl mb-4 hover:drop-shadow-2xl border border-gray-400 lg:border-l lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b lg:rounded-t p-4 flex flex-col justify-between leading-normal"
